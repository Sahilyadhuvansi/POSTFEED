...
import CreatePostMusicSection from "./CreatePostMusicSection";
...
const CreatePost = () => {
  ...
  const {
    ...
    clearImage,
    handleSubmit,
  } = useCreatePostController({ addToast, navigate });
      ...
      <div className="relative w-full max-w-2xl glass rounded-[40px] p-8 md:p-12 shadow-[0_32px_128px_rgba(0,0,0,0.8)] border-white/5">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <CreatePostMusicSection
            ...
            handleMusicSearch={handleMusicSearch}
